...
#pragma mark - BoxShadow

#define setBoxShadowColor()                      \
...
#define setBoxShadowOpacity()                      \
  - (void)setBoxShadowOpacity:(CGFloat)opacity \
{                                              \
    NSLog(@"setBoxShadowOpacity %f", opacity);          \
    _boxShadowOpacity = opacity;                    \
    [self.layer setNeedsDisplay];           \
}
setBoxShadowOpacity()
